   ...
   <main style="height:80%">
    <section  style="margin-left:10%;margin-right:10%;padding:2%;border-radius:1.5em;margin-top:2%;" class="card" id="main">
        <div class="panel-heading" style="margin-bottom:1%">
              <div class="panel-title card-header"><h4>Formulario Producto</h4></div>
        </div>
    ...
    <table class="table">
        <tbody>
            ...
            <tr {{ $errors->has('description') ? 'class=has-error' : '' }}>
                    ...
                    <td>
                        <?php $curValue = old('description') ? old('description') : (!empty($prodcut->description)?$product->description:'') ?>
    ...
    <div>
        {{ Form::submit('Crear Producto',['class'=>'btn btn-primary','style=font-size:0.8em']) }}
