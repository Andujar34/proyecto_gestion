   ...
   <main style="height:80%;">
    <section style="margin-left:10%;margin-right:10%;padding:2%;border-radius:1.5em;margin-top:2%;" class="card" id="main">
        <div class="panel-heading" style="margin-bottom:1%">
             <div class="panel-title card-header"><h4>Formulario Proveedor</h4></div>
        </div>
        ...
        <tbody>
            <tr {{ $errors->has('name') ? 'class=has-error' : '' }}>
                ...
                <td>
                    ...
                    {{ Form::text('name', $curValue, ['class' => 'form-control ' . ($errors->has('name') ? 'has-error' : '')]) }}
                    @if ($errors->has('name'))
            ...
            <tr {{ $errors->has('address') ? 'class=has-error' : '' }}>
                ...
                <td>
                    ...
                    {{ Form::text('address', $curValue, ['class' => 'form-control ' . ($errors->has('address') ? 'has-error' : '')]) }}
            ...
            <tr {{ $errors->has('CIF') ? 'class=has-error' : '' }}>
                ...
                <td>
                    ...
                    {{ Form::text('CIF', $curValue, ['class' => 'form-control ' . ($errors->has('CIF') ? 'has-error' : '')]) }}
                    @if ($errors->has('CIF'))
            ...
            <tr {{ $errors->has('phone') ? 'class=has-error' : '' }}>
                ...
                <td>
                    ...
                    {{ Form::text('phone', $curValue, ['class' => 'form-control ' . ($errors->has('phone') ? 'has-error' : '')]) }}
                    @if ($errors->has('phone'))
            ...
            <tr {{ $errors->has('cc') ? 'class=has-error' : '' }}>
                ...
                <td>
                    ...
                    {{ Form::text('cc', $curValue, ['class' => 'form-control ' . ($errors->has('cc') ? 'has-error' : '')]) }}
                    @if ($errors->has('cc'))
    ...
    <div>
        {{ Form::submit('Crear Proveedor',['class'=>'btn btn-primary',"style=font-size:0.8em"]) }}
